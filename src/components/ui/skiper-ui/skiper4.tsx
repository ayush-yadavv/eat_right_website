...
import { useThemeToggle, type AnimationVariant, type AnimationStart } from "./skiper26";
...
export const ThemeToggleButton5 = ({
  ...
  return (
    <button
      type="button"
      className={cn(
        "size-9 cursor-pointer rounded-full p-2 transition-all duration-300 active:scale-95 border border-border/80 bg-surface/80 hover:bg-surface text-text-main shadow-xs flex items-center justify-center",
        className,
      )}
      onClick={toggleTheme}
...
export const ThemeToggleButton1 = ({
  ...
  return (
    <button
      type="button"
      className={cn(
        "size-9 rounded-full bg-surface border border-border text-text-main transition-all duration-300 active:scale-95 flex items-center justify-center p-2",
        className,
      )}
      onClick={toggleTheme}
      aria-label="Toggle theme"
...
export const ThemeToggleButton2 = ({
  ...
  return (
    <button
      type="button"
      className={cn(
        "size-9 rounded-full transition-all duration-300 active:scale-95 border border-border bg-surface text-text-main flex items-center justify-center p-2",
        className,
      )}
      onClick={toggleTheme}
      aria-label="Toggle theme"
...
/**
 * Skiper 4 Theme Toggle Animations
 * Author: @gurvinder-singh02
 * Website: https://gxuri.me | https://skiper-ui.com/v1/skiper4
 */
