...
export const ThemeToggleButton = ({
  ...
  return (
    <button
      type="button"
      className={cn(
        "size-9 cursor-pointer rounded-full p-1.5 transition-all duration-300 active:scale-95 border border-border bg-surface text-text-main hover:bg-surface-hi/20 shadow-xs flex items-center justify-center",
        className,
      )}
      onClick={toggleTheme}
